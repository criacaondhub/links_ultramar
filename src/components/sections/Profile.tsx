  ...
  return (
    <section className="flex flex-col items-center px-2 pt-0 pb-6 text-center">
      ...
      <motion.p
        ...
        className="mt-2 w-full max-w-[520px] text-[13px] leading-snug tracking-tight uppercase font-extrabold text-[var(--color-text)] md:max-w-[1100px] md:text-[34px] md:tracking-normal"
